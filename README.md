...
| `Shift+Frecce` / `Shift+PageUp` / `Shift+PageDown` | Estende/crea la selezione di testo (non funziona su Terminal.app di macOS — usa `Ctrl-T`) |
| `Ctrl-T` | Attiva/disattiva la modalità selezione: con la modalità attiva frecce e PageUp/PageDown semplici estendono la selezione come farebbe Shift — funziona su ogni terminale, incluso Terminal.app |
| Invio | Nuova riga |
